package com.cartigo.product.config;
 ...
 * This service can run with permitAll=true for internal traffic.
 */
@Configuration
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> {}) // ✅ IMPORTANT: allow CORS to be applied with Spring Security
